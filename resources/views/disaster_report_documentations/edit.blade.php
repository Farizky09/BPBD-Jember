...
@section('breadcrumb')
    ...
    @endphp
    <x-breadcrumb :links="$links" title="Edit Laporan" class="text-center" />
@endsection

<div class="form-container">
    <form id="form-disasterReportDocumentations" action="{{ route('disaster_report_documentations.update', $data->id) }}"
                ...
                <select class="select2 form-select @error('confirm_report_id') border-red-500 @enderror"
                    ...
                    @foreach ($confirmReports as $confirmReport)
                        <option value="{{ $confirmReport->id }}"
                            {{ old('confirm_report_id', $data->confirm_report_id) == $confirmReport->id ? 'selected' : '' }}>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="form-group">
                    ...
                    <textarea class="summernote @error('disaster_chronology') border-red-500 @enderror" id="disaster_chronology"
                        name="disaster_chronology">{{ old('disaster_chronology', $data->disaster_chronology) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="summernote @error('disaster_impact') border-red-500 @enderror" id="disaster_impact"
                        name="disaster_impact">{{ old('disaster_impact', $data->disaster_impact) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea class="summernote @error('disaster_response') border-red-500 @enderror" id="disaster_response"
                        name="disaster_response">{{ old('disaster_response', $data->disaster_response) }}</textarea>
        ...
        @if ($imageCount < 3)
            <div class="image-upload-section">
                ...
                <p class="text-sm text-slate-600 mb-4">Unggah gambar dokumentasi bencana (maksimal 3 file, format:
                    JPG/PNG,
                    maks 2MB per file)</p>
                ...
                <div class="image-upload-container" id="image-upload-container">
                    <div class="image-upload-item">
                        <input type="file" class="form-input @error('image.*') border-red-500 @enderror"
                            name="image[]" accept="image/*" onchange="validateImage(this)">
